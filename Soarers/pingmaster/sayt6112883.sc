...
matrix
	...
	muxstrobe 10	UNASSIGNED	PAD_0	INTERNATIONAL_1	BACK_QUOTE	RIGHT_BRACE	EQUAL			UNASSIGNED	UNASSIGNED	
	muxstrobe 11	PAD_3		PAD_6		RSHIFT			ENTER		BACKSLASH	INTERNATIONAL_3	UNASSIGNED	UNASSIGNED	
	# 6
	muxstrobe 12	PAD_2		PAD_5		MEDIA_PLAY_PAUSE		MEDIA_NEXT_TRACK	MEDIA_PREV_TRACK	BACKSPACE		PAD_COMMA	PAD_0	
	muxstrobe 13	PAD_ASTERIX	PAD_9		EXTRA_F8		PAD_4		PAD_8		PAD_SLASH		END			BACKSPACE	
	# 7										^ orig PAD_1
	muxstrobe 14	PAD_MINUS	PAD_PLUS	UP				DELETE		PAD_7		NUM_LOCK		INSERT		PRINTSCREEN	
	muxstrobe 15	PAD_ENTER	PAD_PERIOD	FN2		PAGE_DOWN	PAGE_UP		PAUSE			HOME		SCROLL_LOCK	
	#										^ orig PAD_3
end
